...
export default function AddNewStudent() {
  ...
  useEffect(() => {
    async function load() {
      ...
      const [{ data: staffData }, { data: usersData }] = await Promise.all([
        supabase
          .from("staff")
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (insertErr || !newStudent) {
      setError("Error creating student: " + (insertErr?.message ?? "unknown error"));
  ...
  return (
    <div className="px-4 py-8 sm:px-8 sm:py-10 max-w-2xl mx-auto font-sans">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-400 mt-1">Creates a permanent student file.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <div className="flex gap-3 pt-1">
          ...
          >
            {isSubmitting ? "Creating student file..." : "Create Student File"}
          </button>
        </div>
